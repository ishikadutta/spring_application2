...
public class EmployeeController {
    ...
    public List<EmployeeResponseDTO> getMostExperienced(){
        return employeeService.getMostExperienced();
    }

    @GetMapping("/mostExperienced/{departmentId}")
    public List<EmployeeResponseDTO> getMostExperiencedInDepartment(@PathVariable("departmentId") Long departmentId){
        return employeeService.getMostExperiencedInDepartment(departmentId);
    }
}
